...
<script type="text/javascript">
      ...
      function Rverifica(){
          ...
          if (verifica.length<6) {
             ...
             // alert("Su Codígo no Posee los 6 Digitos");
...
<input type="hidden" name="j_idt64:j_idt66" value="j_idt64:j_idt66" />
    ...
    <div align="center"><label style="color:#A1BF37">CARGANDO<br></label>
       ...
       <h4><label style="color:white;" id="Mostrar">Por favor espere mientras verificamos su Codigo.<br> 
         ...
         <h3><label  style="color:red;" id="count" hidden></label></h3>
...
<p align="center">
          <strong>Estimado usuario,</strong> ingrese el c&oacute;digo enviado a su celular y/o JEPTOKEN para continuar la verificaci&oacute;n.<br />
        </p>
